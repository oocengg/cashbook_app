...
String formatDateHHmm(String dateStr) {
  initializeDateFormatting('id_ID', null);
  DateTime date = DateTime.parse(dateStr);
  String formattedDate = DateFormat("HH:mm", 'id_ID').format(date);
  return formattedDate;
}
...
String formatDatedd(String dateStr) {
  initializeDateFormatting('id_ID', null);
  DateTime date = DateTime.parse(dateStr);
  String formattedDate = DateFormat("dd", 'id_ID').format(date);
  return formattedDate;
}
...
String formatDateMMM(String dateStr) {
  initializeDateFormatting('id_ID', null);
  DateTime date = DateTime.parse(dateStr);
  String formattedDate = DateFormat("MMM", 'id_ID').format(date);
  return formattedDate;
}
...
// Format Date into Indonesian Output : Sabtu, 01 Januari 2022
String formatDateEEEEddMMyyyyHHmm(String dateStr) {
  initializeDateFormatting('id_ID', null);
  DateTime date = DateTime.parse(dateStr);
